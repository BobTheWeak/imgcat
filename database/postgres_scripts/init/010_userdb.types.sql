...
BEGIN
	RETURN CASE val
		...
		WHEN 'FRIENDS ONLY'::UserDB.VISIBILITY_LEVEL THEN 2
		WHEN 'PUBLIC'::UserDB.VISIBILITY_LEVEL THEN 3
		ELSE NULL
	END CASE;
END $$;
...
BEGIN
	RETURN CASE val
		...
		WHEN 2 THEN 'FRIENDS ONLY'::UserDB.VISIBILITY_LEVEL
		WHEN 3 THEN 'PUBLIC'::UserDB.VISIBILITY_LEVEL
		ELSE NULL
	END CASE;
END $$;
